#ifndef __groestl_intermediate_h
#define __groestl_intermediate_h
...
/* helper functions */
void PrintDiff(const hashState *ctx, u8 x[ROWS][COLS1024], u8 y[ROWS][COLS1024]);
void PrintState(const hashState *, u8[ROWS][COLS1024]);
void PrintHash(BitSequence *, int);

#endif /* __groestl_intermediate_h */
